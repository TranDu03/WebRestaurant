...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <button type="submit" class="fas fa-times" name="delete" onclick="return confirm('Bạn có chắc muốn xóa?');"></button>
         ...
         <div class="sub-total"> Tạm tính : <span>$<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
      </form>
      <?php
   ...
   <div class="cart-total">
      <p>Tổng giá trị giỏ hàng : <span>$<?= $grand_total; ?></span></p>
   ...
   <div class="more-btn">
      ...
      <a href="menu.php" class="btn">Tiếp tục xem món</a>
   </div>
