...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      ?>
      <p class="grand-total"><span class="name">Tổng cộng :</span><span class="price">$<?= $grand_total; ?></span></p>
   ...
   <div class="user-info">
      ...
      <a href="update_address.php" class="btn">Cập nhật</a>
