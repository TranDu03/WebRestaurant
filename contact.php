...
<div class="heading">
   <h3>Phản hồi</h3>
   <p><a href="home.php">Trang chủ</a> <span> / Phản hồi</span></p>
</div>
...
<section class="contact">
   ...
   <div class="row">
      ...
      <form action="" method="post">
         <h3>Hãy phản hồi với chúng tôi !</h3>
         ...
         <textarea name="msg" class="box" required placeholder="Nhập phản hồi" maxlength="500" cols="30" rows="10"></textarea>
